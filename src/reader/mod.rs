...
mod tests {
    ...
    fn test_objects_iter() {
        let rdr = Reader::new(BufReader::new(File::open("src/tests/basic.pdf").unwrap()));
    ...
    fn test_xref_chaining() {
        let rdr = Reader::new(BufReader::new(File::open("src/tests/hybrid.pdf").unwrap()));
        ...
        let rdr = Reader::new(BufReader::new(File::open("src/tests/updates.pdf").unwrap()));
        ...
        let rdr = Reader::new(BufReader::new(File::open("src/tests/circular.pdf").unwrap()));
    ...
    fn test_objstm_caching() {
        let rdr = Reader::new(BufReader::new(File::open("src/tests/objstm.pdf").unwrap()));
        let loc = rdr.base_locator();
